...
INSERT INTO chats (recipient_id, message, start_date, end_date, receiver_username, sender_username, sender_id) VALUES (2, '{"user01: Hello user 02"}', '2024-01-31','2024-03-01', 'user02', 'user01', 1);
INSERT INTO chats (recipient_id, message, start_date, end_date, receiver_username,sender_username, sender_id) VALUES (1, '{"user02: Hello user 01"}', '2024-01-31','2024-03-01', 'user01', 'user02', 2);
