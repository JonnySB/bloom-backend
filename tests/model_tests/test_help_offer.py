...
def test_initial_attributes():
    offer = HelpOffer(1, 1, 'Willing to help', 3.75, 'Pending')
    assert offer.id == 1
...
"""
def test_equality():
    offer_1 = HelpOffer(1, 1, 'Willing to help', 3.75, 'Pending')
    offer_2 = HelpOffer(1, 1, 'Willing to help', 3.75, 'Pending')
...
def test_str_formatting():
    offer = HelpOffer(1, 1, 'Willing to help', 3.75, 'Pending')
    assert str(offer) == "HelpOffer(1, 1, Willing to help, 3.75, Pending)"