...
def test_constructs_help_request_with_fields():
    help_request = HelpRequest(
        1,
        datetime.datetime(2024, 2, 1, 10, 30, 45),
        "Need help with gardening",
        "Looking for someone to help with planting flowers.",
...
def test_help_request_formats_nicely():
    ...
    assert (
        str(help_request)
        == "HelpRequest(1, 2024-02-01 10:30:45, Need help with gardening, Looking for someone to help with planting flowers., 2024-01-01, 2024-01-31, 1, 100)"
    )
