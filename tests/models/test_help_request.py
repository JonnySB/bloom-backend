...
def test_help_requests_are_equal():
    help_request_1 = HelpRequest(1, 1, datetime(2024, 2, 1, 10, 30, 45), "Need help with gardening", "Looking for someone to help with planting flowers.", "Rose", "2024-03-01 to 2024-03-07", 100)
    help_request_2 = HelpRequest(1, 1, datetime(2024, 2, 1, 10, 30, 45), "Need help with gardening", "Looking for someone to help with planting flowers.", "Rose", "2024-03-01 to 2024-03-07", 100)
...
def test_help_request_formats_nicely():
    help_request = HelpRequest(1, 1, datetime(2024, 2, 1, 10, 30, 45), "Need help with gardening", "Looking for someone to help with planting flowers.", "Rose", "2024-03-01 to 2024-03-07", 100)
    assert str(help_request) == "HelpRequest(1, 1, 2024-02-01 10:30:45, Need help with gardening, Looking for someone to help with planting flowers., Rose, 2024-03-01 to 2024-03-07, 100)"
